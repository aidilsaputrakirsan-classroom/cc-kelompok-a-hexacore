    ...
    <div>
      ...
      {!isAdmin &&
        ...
        statusF === null && (
          ...
          >
            ...
            <div>
              <strong>
                Anda dilaporkan menghilangkan{" "}
                {displayFines.filter((f) => f.status === "unpaid").length} buku!
              </strong>{" "}
              Segera lunasi tagihan ganti rugi Rp 100.000 (per buku) agar dapat
              meminjam kembali.
            </div>
          </div>
        )}
      ...
      {loading ? (
        ...
        <Empty
          ...
          title="Aman"
          sub={
            statusF ? "Coba filter lain" : "Tidak ada catatan kehilangan buku"
          }
        />
      ) : (
      ...
      {proofModal && (
        <Modal
          title="Kirim Bukti Pembayaran Kehilangan"
          onClose={() => {
            setProofModal(null);
            setProofFile(null);
            setProofUrl("");
