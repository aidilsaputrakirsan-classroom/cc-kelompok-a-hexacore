    ...
    <div className="login-page">
      ...
      <div className="login-left">
        <div className="login-left-inner">
          ...
          <p className="login-left-desc">
            Sistem perpustakaan digital untuk meminjam, mengelola koleksi, dan
            melacak transaksi secara efisien.
          </p>
          {[
            "Manajemen buku & kategori lengkap",
            "Alur peminjaman dengan approval admin",
            "Pelacakan denda otomatis",
      ...
      <div className="login-right">
        <div className="login-card">
          <h2 className="login-brand-title">LENTERA PUSTAKA</h2>
